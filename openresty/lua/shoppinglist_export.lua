...
-- TODO: add resty-jwt https://github.com/toopy/lua-resty-jwt 
-- prepare the payload for the http request
-- we need to create a jwt token to authenticate the request
local function generate_jwt(listan_user_name)
    local secret = os.getenv("JWT_SECRET") -- Shared secret between listan and receptdatabasen
...
-- Example usage
local jwt_token = generate_jwt(user_name) -- assume same user_name in both servies
